 ...
 *
 * @deprecated moved to geodrec subpackage
 */
@Deprecated
public class GeodesicReconstructionByDilation extends ijt.filter.morphology.geodrec.GeodesicReconstructionByDilation {
